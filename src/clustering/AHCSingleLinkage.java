...
public class AHCSingleLinkage extends AHC 
{

    public AHCSingleLinkage (Dataset data, boolean buildDendrogram) 
    {
        this.dataset = data;
        this.simMatrix = null;
     ...
     *        The algorithm ends when the similarity level specified by simThreshold 
     *        is reached.
     *      </p>
     */
    public Clustering execute (Similarity sim, double simThreshold) 
    {
        return null;
    }

    public Clustering[] executeMultiRun (Similarity sim, double simThreshold, int runs) 
    {
        return null;
    }
        ...
        while (nClusterCurr>nClusters)
        {
            ...
            for (int j=index1+1; j<simMatrix.length; j++)
            {
                if (clusters[j] != null)
                {
                    ...
                    simMatrix[index1][j] = (dOld1>dOld2)?dOld1:dOld2;
                }
            }
            //column update
            {
                for (int i=0; i<index1; i++)
                {
                    if (clusters[i] != null)
                    {
                        ...
                        simMatrix[i][index1] = (dOld1>dOld2)?dOld1:dOld2;
                    }
                }
            }
