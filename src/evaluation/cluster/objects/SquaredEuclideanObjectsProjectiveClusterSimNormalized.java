...
public class SquaredEuclideanObjectsProjectiveClusterSimNormalized extends ProjectiveClusterObjectsSimilarity {

    private int k;

    public SquaredEuclideanObjectsProjectiveClusterSimNormalized(int k)
    {
        this.k = k;
    }
    ...
    {
        if (!(o instanceof SquaredEuclideanObjectsProjectiveClusterSimNormalized))
        {
            return false;
        }
