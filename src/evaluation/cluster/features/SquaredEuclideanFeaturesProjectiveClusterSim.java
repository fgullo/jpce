...
public class SquaredEuclideanFeaturesProjectiveClusterSim extends ProjectiveClusterFeaturesSimilarity {
    ...
    {
        if (!(o instanceof SquaredEuclideanFeaturesProjectiveClusterSim))
        {
            return false;
        }
