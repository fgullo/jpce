...
public class CEObjectsFeaturesProjectiveClusteringSim extends ProjectiveClusteringObjectsFeaturesSimilarity
{
    private ProjectiveClusterObjectsFeaturesSimilarity objectsSim;

    public CEObjectsFeaturesProjectiveClusteringSim (ProjectiveClusterObjectsFeaturesSimilarity objectsSim)
    {
        super(false);
    ...
    public CEObjectsFeaturesProjectiveClusteringSim (ProjectiveClusterObjectsFeaturesSimilarity objectsSim, boolean b)
    {
        super(b);
        this.objectsSim = objectsSim;
        //this.onlyHard = false;
    ...
    {
        if (!(o instanceof CEObjectsFeaturesProjectiveClusteringSim))
        {
            return false;
        }
