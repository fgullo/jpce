...
public class MOEAClusteringBasedPCE_OPTIMIZED extends ClusteringBasedPCEMethod
{
    ...
    public MOEAClusteringBasedPCE_OPTIMIZED(ProjectiveClusteringDataset ensemble, int maxIterations, ProjectiveClusteringObjectsSimilarity objectClusteringSim, ProjectiveClusteringFeaturesSimilarity featureClusteringSim,  int populationSize)
    {
    ...
    public ProjectiveClustering execute(int nc)
    {
        ...
        NSGA_II nsgaII = new NSGA_II(initialSolutions, functions);
        //System.out.println("MOEAClusteringBasedPCE_OPTIMIZED---started");
        GASolution[] result = nsgaII.execute(this.maxIterations);
