...
import moea.InstanceBasedFeaturePartitioningGAFunction;
import moea.InstanceBasedObjectPartitioningGAFunction;
import moea.NSGA;
...
public class MOEAInstanceBasedPCE extends InstanceBasedPCEMethod
{
    ...
    public MOEAInstanceBasedPCE(ProjectiveClusteringDataset ensemble, int maxIterations, PDFSimilarity pdfSim, NumericalInstanceSimilarity numSim, int populationSize)
    {
        ...
        this.coNonOccurrenceObjectMatrix = this.ensemble.getWholeCoNonOccurrenceObjectMatrix(pdfSim);
    }
    
    public ProjectiveClustering execute(int nc)
    {
        GAFunction objectFunction = new InstanceBasedObjectPartitioningGAFunction(this.coNonOccurrenceObjectMatrix);
        GAFunction featureFunction = new InstanceBasedFeaturePartitioningGAFunction(this.pairwiseObjectDistances);
        ...
        System.out.println("MOEAInstanceBasedSubspaceEnsembles---started");
