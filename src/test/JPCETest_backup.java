...
public class JPCETest_backup
{
    ...
    private static int numberOfTestEvaluationMeasures = (!fm || !entropy)?7:13;
    ...
    public static void main(String[] args)
    {
        ...
        if (do_PCE)
        {
            ...
            if(fm)
            {
                testEvaluationMeasures[index++] = new ReferencePartitionPCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, fmObjectsSim, "Theta_o (FM)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new ReferencePartitionPCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, fmFeaturesSim, "Theta_f (FM)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new ReferencePartitionPCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, fmSim, "Theta_{of} (FM)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
            }
            if(entropy)
            {
                testEvaluationMeasures[index++] = new ReferencePartitionPCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, entropyObjectsSim, "Theta_o (ENTROPY)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new ReferencePartitionPCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, entropyFeaturesSim, "Theta_f (ENTROPY)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new ReferencePartitionPCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, entropySim, "Theta_{of} (ENTROPY)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
            }
            ...
            if (fm)
            {
                testEvaluationMeasures[index++] = new EnsemblePCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, fmObjectsSim, "Upsilon_o (FM)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new EnsemblePCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, fmFeaturesSim, "Upsilon_f (FM)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new EnsemblePCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, fmSim, "Upsilon_{of} (FM)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
            }
            if (entropy)
            {
                testEvaluationMeasures[index++] = new EnsemblePCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, entropyObjectsSim, "Upsilon_o (ENTROPY)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new EnsemblePCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, entropyFeaturesSim, "Upsilon_f (ENTROPY)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
                testEvaluationMeasures[index++] = new EnsemblePCETestEvaluation(validDatasetNames, validMethodNames, nEnsembles, numberOfRuns, outputPath, null, entropySim, "Upsilon_{of} (ENTROPY)", printCompleteCSV, printSummaryCSV, printSummaryCSV_extended);
            }
...
//DATASET
    ...
    private static void loadProperties()
    {
        ...
        if (do_PCE)
        {
            ...
            numberOfTestEvaluationMeasures = (!fm || !entropy)?7:13;
