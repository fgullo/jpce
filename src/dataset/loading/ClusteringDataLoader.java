...
public class ClusteringDataLoader extends DataLoader {

    public ClusteringDataLoader (String datasetPath) {
    }

    public ClusteringDataLoader (String datasetPath, String refPartitionPath) {
    }
